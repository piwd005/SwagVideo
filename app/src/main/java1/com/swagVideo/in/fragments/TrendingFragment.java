                    ...
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            for (int j = 0; j < jsonArrayOther.length(); j++) {
                                ...
                                try {
                                    viewCount = viewCount + jsonObject2.getInt("views_count");
                                } catch (Exception e) {
                                    e.printStackTrace();
                                }
                            }
                            ...
                            nearBylIsts.add(new TrendingList(hashtag, tagImage, tagDesc, String.valueOf(viewCount), myModelList, myModelLatestList));
